...
module.exports = {
    ...
    rules: {
        ...
        quotemark: [true, 'single', 'jsx-double'], // 6.1
        'no-eval': true, // 6.4
        ...
        'comment-format': [true, 'check-space'], // 17.3
        indent: [true, 'space'],
        'ter-indent': [true, 4, { SwitchCase: 1 }], // 18.1
        whitespace: [
            true,
            'check-branch', // 18.3
            'check-decl', // 18.4
        ...
        eofline: true, // 18.5
        'space-in-parens': [true, 'never'], // 18.9
        'array-bracket-spacing': [true, 'never'], // 18.10
        'object-curly-spacing': [true, 'always'], // 18.11
        'max-line-length': [true, 100], // 18.12
        'trailing-comma': [
            true,
            {
                multiline: 'always',
        ...
        semicolon: [true, 'always', 'ignore-bound-class-methods'], // 20.1
        radix: true, // 21.3
